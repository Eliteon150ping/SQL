...
FROM 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_4\us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);
...
FROM 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_4\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
-- Listing 4-6 Use a temporary table to add a default value to a column during import --
...
COPY us_counties_2010
TO 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_4\us_counties_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');

-- Listing 4-8: Exporting selected columns from a table with COPY --

COPY us_counties_2010 (geo_name, internal_point_lat, internal_point_lon)
TO 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_4\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
TO 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_4\us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
