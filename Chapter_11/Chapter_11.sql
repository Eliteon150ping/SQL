...
SELECT '1299-09-30'::date - '1299-09-27'::date;
SELECT '1299-09-30'::date + '5 years'::interval;
...
FROM 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_11\yellow_tripdata_2016_06_01.csv'
...
TO 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_11\hourly_pickups_2016_06_01.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
