-- Chapter 9: Inspecting and modifyind Data --
...
FROM 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_9\MPI_Directory_by_Establishment_Name.csv'
...
COPY state_regions
FROM 'D:\Bootcamp\2_Java\1_SQL\my_source_code\Chapter_9\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
